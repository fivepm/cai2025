            ...
            <nav class="mt-10"
                ...
                <div>
                    ...
                    <div x-show="isMasterDataOpen" x-transition class="mt-2 ml-4 space-y-2 border-l-2 border-yellow-500">
                        <a href="sekretaris?page=master/manajemen_peserta" class="block px-4 py-2 rounded-md text-sm <?php echo $current_page == 'master/manajemen_peserta' ? 'text-yellow-300 font-semibold' : 'text-gray-300 hover:text-yellow-300'; ?>">
                            Peserta Hadir
                        </a>
                        <a href="sekretaris?page=master/manajemen_izin" class="block px-4 py-2 rounded-md text-sm <?php echo $current_page == 'master/manajemen_izin' ? 'text-yellow-300 font-semibold' : 'text-gray-300 hover:text-yellow-300'; ?>">
                            Peserta Izin
                        </a>
                        <a href="sekretaris?page=master/rekap_pendaftar" class="block px-4 py-2 rounded-md text-sm <?php echo $current_page == 'master/rekap_pendaftar' ? 'text-yellow-300 font-semibold' : 'text-gray-300 hover:text-yellow-300'; ?>">
                            Rekap Pendaftar
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div x-show="isAdministrasiOpen" x-transition class="mt-2 ml-4 space-y-2 border-l-2 border-yellow-500">
                        <a href="sekretaris?page=administrasi/surat_perizinan" class="block px-4 py-2 rounded-md text-sm <?php echo $current_page == 'administrasi/surat_perizinan' ? 'text-yellow-300 font-semibold' : 'text-gray-300 hover:text-yellow-300'; ?>">
                            Surat Perizinan
                        </a>
                        <a href="sekretaris?page=administrasi/surat_undangan" class="block px-4 py-2 rounded-md text-sm <?php echo $current_page == 'administrasi/surat_undangan' ? 'text-yellow-300 font-semibold' : 'text-gray-300 hover:text-yellow-300'; ?>">
                            Undangan Pemateri
                        </a>
